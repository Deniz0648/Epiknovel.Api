      ...
      <AuthShell
        ...
        footer={
          <p className="mx-auto max-w-sm text-center text-xs leading-relaxed text-base-content/55">
            Giris yaparak <button type="button" onClick={() => setLegalSlug("terms-of-service")} className="font-semibold text-primary hover:underline">Kullanim Kosullarini</button> ve{" "}
            <button type="button" onClick={() => setLegalSlug("privacy-policy")} className="font-semibold text-primary hover:underline">Gizlilik Politikamizi</button> kabul etmis olursunuz.
          </p>
        }
      >
