  ...
  return (
    <div className="flex h-full lg:h-[calc(100vh-120px)] flex-col gap-4 lg:gap-6 p-2 md:p-4 lg:p-0">
      ...
      <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
        {/* User Table Card */}
        <div className={`flex flex-col flex-1 rounded-[1.5rem] md:rounded-[2.5rem] border border-base-content/5 bg-base-100/50 backdrop-blur-md overflow-hidden ${selectedUser ? "hidden" : "flex"}`}>
                      ...
                      {["User", "Author", "Mod", "Admin", "SuperAdmin"].map((r) => {
                         ...
                         return (
                            <button
                               ...
                               className={`flex-1 min-w-[80px] px-3 py-2 rounded-xl text-[9px] font-black uppercase tracking-tighter transition-all border ${
                                  isActive 
              ...
              <div className="rounded-[2.5rem] border border-base-content/5 bg-base-100/50 p-6">
                 ...
                 <div className="space-y-3">
                    {isLoadingDetails ? (
                       ...
                       <div className="text-center py-6 text-[10px] font-medium opacity-20 italic font-bold uppercase tracking-widest">İşlem geçmişi yok.</div>
                    ) : (
              ...
              <div className="rounded-[2.5rem] border border-base-content/5 bg-base-100/50 p-6">
                 ...
                 <div className="flex flex-col gap-4">
                    {isLoadingDetails ? (
                       ...
                       <div className="text-center py-6 text-[10px] font-medium opacity-20 italic font-bold uppercase tracking-widest">Yayınlanan kitap yok.</div>
                    ) : (
              ...
              <div className="rounded-[2.5rem] border border-base-content/5 bg-base-100/50 p-6">
                 ...
                 <div className="flex flex-col gap-3">
                    {isLoadingDetails ? (
                       ...
                       <div className="text-center py-6 text-[10px] font-medium opacity-20 italic font-bold uppercase tracking-widest">Henüz bir satın alım yok.</div>
                    ) : (
