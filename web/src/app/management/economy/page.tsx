      ...
      <div className="space-y-8">
         ...
         <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
               ...
               <div key={i} className="glass-island rounded-4xl p-6 transition-transform hover:scale-[1.02]">
               ...
               {[
                  ...
                  return (
                     <button
                        ...
                        className={`flex items-center gap-2.5 rounded-[1.4rem] px-6 py-3 text-sm font-bold transition-all ${isActive
               ...
               <div className="glass-island rounded-[2.5rem] p-8 md:p-12 overflow-hidden relative">
                  ...
                  <div className="relative z-10">
                     ...
                     {isLoading ? (
                        ...
                        <div className="mt-10 flex flex-col items-center justify-center border border-dashed border-base-content/10 rounded-4xl p-20 text-center bg-base-content/2">
                              ...
                              <div key={cp.id} className={`flex flex-col md:flex-row items-center gap-6 rounded-3xl border p-6 transition hover:bg-base-content/5 ${cp.isActive ? 'border-base-content/10 bg-base-100/20' : 'border-dashed border-base-content/20 opacity-60 bg-base-content/5'}`}>
                                 ...
                                 <div className="flex-1 min-w-0 text-center md:text-left">
                                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                                       ...
                                       <span className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full ring-1 ${cp.targetType === CampaignTargetType.Global ? "bg-primary/10 text-primary ring-primary/20" :
                              ...
                              {isOrderLoading ? (
                                 ...
                                 orders.map(order => (
                                    <tr key={order.id} className="border-t border-base-content/5 hover:bg-base-content/2 transition-colors">
                                       ...
                                       <td className="px-6 py-4">
                                          <span className={`rounded-full px-2.5 py-1 text-[10px] font-black uppercase ${order.status === OrderStatus.Paid ? "bg-success/10 text-success" :
                              ...
                              {isWithdrawLoading ? (
                                 ...
                                 withdrawals.map(req => (
                                    <tr key={req.id} className="border-t border-base-content/5 hover:bg-base-content/2 transition-colors">
                                       ...
                                       <td className="px-6 py-4">
                                          <span className={`rounded-full px-2.5 py-1 text-[10px] font-black uppercase ${req.status === WithdrawStatus.Pending ? "bg-warning/10 text-warning" :
                  ...
                  <div className="grid gap-6">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <button
                           ...
                           className={`h-12 rounded-xl border-2 flex items-center justify-center gap-2 font-bold text-sm transition ${withdrawProcessData.status === WithdrawStatus.Approved
                        ...
                        <button
                           ...
                           className={`h-12 rounded-xl border-2 flex items-center justify-center gap-2 font-bold text-sm transition ${withdrawProcessData.status === WithdrawStatus.Rejected
                     ...
                     {withdrawProcessData.status === WithdrawStatus.Approved ? (
                        <div className="grid gap-4">
                           ...
                           <div className="relative">
                              <label className={`flex flex-col items-center justify-center h-32 rounded-3xl border-2 border-dashed transition-all cursor-pointer ${withdrawProcessData.receiptId
                     ...
                     <div className="grid gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           <button
                              ...
                              className={`h-12 rounded-xl border-2 flex items-center justify-center gap-2 font-bold text-sm transition ${campaignFormData.sponsorType === CampaignSponsorType.Platform
                           ...
                           <button
                              ...
                              className={`h-12 rounded-xl border-2 flex items-center justify-center gap-2 font-bold text-sm transition ${campaignFormData.targetType === CampaignTargetType.Global ? 'opacity-30 cursor-not-allowed' : ''
