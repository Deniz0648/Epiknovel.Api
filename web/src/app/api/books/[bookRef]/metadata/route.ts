...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const response = NextResponse.json({ isSuccess: true, message: "Kitap metadata guncellendi.", data: result.data });
    ...
    return NextResponse.json({ isSuccess: false, message: "Kitap metadata guncellenemedi." }, { status: 500 });
  }
}
