...
public interface INotificationService
{
    ...
    Task SendTemplatedEmailAsync(string toEmail, string templateKey, Dictionary<string, string> variables, CancellationToken ct = default);
    ...
    Task BroadcastCommentAsync(Guid userId, Guid? bookId, Guid? chapterId, string? paragraphId, CancellationToken ct = default);
}
