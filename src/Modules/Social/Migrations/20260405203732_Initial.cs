...
namespace Epiknovel.Modules.Social.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastReadChapterSlug = table.Column<string>(type: "text", nullable: false),
                    LastReadChapterOrder = table.Column<int>(type: "integer", nullable: false),
                    LastReadParagraphId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE FUNCTION social.notify_social_outbox_inserted() RETURNS trigger AS $$
                BEGIN
                  PERFORM pg_notify('social_outbox_inserted', '');
                  RETURN NEW;
                END;
                $$ LANGUAGE plpgsql;

                CREATE TRIGGER trg_social_outbox_inserted
                AFTER INSERT ON social.""OutboxMessages""
                FOR EACH STATEMENT
                EXECUTE FUNCTION social.notify_social_outbox_inserted();
            ");
        }
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS trg_social_outbox_inserted ON social.\"OutboxMessages\";");
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS social.notify_social_outbox_inserted();");
