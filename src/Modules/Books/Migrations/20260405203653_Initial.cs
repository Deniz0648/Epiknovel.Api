    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE FUNCTION books.notify_books_outbox_inserted() RETURNS trigger AS $$
                BEGIN
                  PERFORM pg_notify('books_outbox_inserted', '');
                  RETURN NEW;
                END;
                $$ LANGUAGE plpgsql;

                CREATE TRIGGER trg_books_outbox_inserted
                AFTER INSERT ON books.""OutboxMessages""
                FOR EACH STATEMENT
                EXECUTE FUNCTION books.notify_books_outbox_inserted();
            ");
        }
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS trg_books_outbox_inserted ON books.\"OutboxMessages\";");
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS books.notify_books_outbox_inserted();");
